...
x_lg_front=                             % front landing gear placement
x_lg_rear=                              % rear landing gear placement
x_fusel=L_nose;                         % fuselage LE placement                               
x_emp=L_nose+L_fusel;                   % tail empennage LE placement
x_t_vert=                               % vertical tail surface LE placement
x_t_horiz=x_t_vert;                     % horizontal tail surface LE placement
x_seat_cp=                              % placement of cockpit seating CG (2 pilots)
x_seat_js=                              % placement of jump seat CG (1 steward(ess))
...
x_seat1=                                % placement of seating section 1 LE (4 people)
x_seat2=                                % placement of seating section 2 LE (4 people)
x_seat3=                                % placement of seating section 3 LE (4 people)
...
L_t_vert_root= Fill in;                 % length of vertical tail surface root chord
