...
q           = 0.5*rho*(0.7*V_T0)^2; %[    ]: Dynamic Pressure 
...
% S is the total runway length required. All of this is based off of
% equations from Lukas and the initial H-something approximations. 
% Need to find updated values from slides for how to do new integral take
% off stuff. 
